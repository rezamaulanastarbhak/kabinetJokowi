...
write.csv(data.tweets,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 2.csv')

##hanya ambil data tweet saja
data.cleaning.text=data.tweets$data.cleaning.text
...
write.csv(clean.html,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 3.csv')
...
write.csv(clean.html,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 4.csv')

remove.retweet <- function(z) gsub("RT @\\S+", "", z)
clean <- tm_map(clean, remove.retweet)
inspect(clean[1:15])
clean.retweet=data.frame(text=unlist(sapply(clean, `[`)), stringsAsFactors=F)
write.csv(clean.retweet,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 5.csv')

clean <- tm_map(clean, tolower)
inspect(clean[1:15])
clean.tolower=data.frame(text=unlist(sapply(clean, `[`)), stringsAsFactors=F)
write.csv(clean.tolower,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 6.csv')
...
write.csv(clean.mention,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 7.csv')
...
write.csv(clean.hashtag,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 8.csv')
...
write.csv(clean.punct,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 9.csv')

remove.all <- function(xy) gsub("[^[:alpha:][:space:]]*", "", xy)
clean <- tm_map(clean,remove.all)
inspect(clean[1:15])
clean.all=data.frame(text=unlist(sapply(clean, `[`)), stringsAsFactors=F)
write.csv(clean.all,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 10.csv')

#remove extra whitespace (spasi)
clean <- tm_map(clean, stripWhitespace)
inspect(clean[1:15])
clean.space=data.frame(text=unlist(sapply(clean, `[`)), stringsAsFactors=F)
write.csv(clean.space,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 11.csv')
...
write.csv(clean.slang,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 12.csv')
...
write.csv(clean.stem,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 13.csv')
...
View(clean.token)
write.csv(clean.token,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 14.csv')
...
View(clean.stopword)
write.csv(clean.stopword,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 15.csv')
...
View(dataframe)
write.csv(dataframe,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//TweetClean Asli.csv')

###------------CARI KATA------------
library(tm)
clean.for.find.word=read.csv('D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//TweetClean Asli.csv', header = T)
...
View(df)
write.csv(df,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Cleaning Asli Poin 16.csv')
