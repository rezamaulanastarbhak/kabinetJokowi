...
tweetclean<-read.csv("D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Result//TweetClean2.csv", stringsAsFactors = FALSE)
...
df <- tweetclean[with(tweetclean, order(-freq)), ]
n=dim(tweetclean)[1]
