...
kalimat2=read.csv('file:///D:/PROJECT/EL-CREATIVEON/05.01.2020 - REZA - Sentimen Analisis/Code/Code Fix/Result/TweetClean Weighted.csv', header = T)
...
View(hasil)
write.csv(hasil,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Scoring Weighted Poin 3.csv')

#CONVERT SCORE TO SENTIMENT
hasil$klasifikasi<- ifelse(hasil$score<0, "Negatif",ifelse(hasil$score>0,"Positif", "Netral"))
head(hasil$klasifikasi, 15)
View(hasil[c(2,3,1)])
write.csv(hasil[c(2,3,1)],file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Scoring Weighted Poin 4.csv')
...
View(data)
write.csv(data,file = 'D://PROJECT//EL-CREATIVEON//05.01.2020 - REZA - Sentimen Analisis//Code//Code Fix//Result//Scoring Weighted Poin 6.csv')
